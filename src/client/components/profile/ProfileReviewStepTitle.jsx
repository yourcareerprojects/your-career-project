...
const REVIEW_STEP_HEADER_CONFIG = {
  ...
  4: { Icon: WorkHistoryIcon, titleKey: 'profilePage.sections.experience' },
  5: { Icon: AssessmentIcon, titleKey: 'documentUpload.review.step5Title' },
};
...
const ProfileReviewStepTitle = ({ step, t, sx }) => {
  ...
  return (
    <Typography
      variant="h6"
      component="h2"
      sx={{ fontWeight: 600, lineHeight: 1.3, ...sx }}
    >
